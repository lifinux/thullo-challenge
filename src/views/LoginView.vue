...
<template>
  <el-row :gutter="20" class="page-sigup" align="middle" justify="center">
    <el-col :span="10">
      <el-form
        ref="formSigup"
        class="form-sigup"
      >
        <img class="logo" src="@/assets/devchallenges.svg" alt="">
        ...
        <el-button class="w-100 t-button" type="primary" @click="abc" :loading="loading">Start coding now</el-button>
        <div class="sigup-social">
          <span>or continue with these social profile</span>
          <div class="sigup-social__box">
